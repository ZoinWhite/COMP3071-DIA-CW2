...
def get_sim(sim_str):
    if sim_str == 'lust':                                        
        ...
        cfg_fp = 'networks/NGSIM.sumocfg'
        net_fp = 'networks/NGSIM.net.xml'
    elif sim_str == 'THRNET':
        cfg_fp = 'networks/THRNET.sumocfg'
        net_fp = 'networks/THRNET.net.xml'
    else:
        raise ValueError(f"Unknown simulation scenario: {sim_str}")
